...
export declare abstract class Compiler {
     ...
     */
    static parseXml(xmlString: string, ruleSet?: SyntaxRuleSet | typeof SyntaxRuleSet): Parser;
    /**
     * Parses an XML string and returns the a syntax tree.
     */
    static parseXmlToAst(xmlString: string, ruleSet?: SyntaxRuleSet | typeof SyntaxRuleSet): DocumentNode;
    /**
     * Parses an XML string to a syntax tree, then serializes it to formatted XML.
     */
    static formatXmlString(xmlString: string, formattingOptions?: IStringificationParams, ruleSet?: SyntaxRuleSet | typeof SyntaxRuleSet): string;
}
